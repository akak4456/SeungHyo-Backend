...
import com.adele.appsubmit.executor.impl.CompileExecutorImpl;
...
public class CompileExecutorTest {
    ...
    public void setUp() {
        ...
        compileExecutor = new CompileExecutorImpl();
    }
    ...
    public void testCompileAndRunSuccess() throws IOException, InterruptedException, ExecutionException {
        ...
        // 비동기 메서드 호출
        CompletableFuture<List<CompileResultDTO>> futureResult = compileExecutor.compileAndRun(
